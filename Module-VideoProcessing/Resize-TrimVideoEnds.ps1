...
# Sample: Should find the prior video generated by `Join-CombineVideos`.
# Resize-TrimVideoEnds -VideoPath "*-combined.mp4" -FFmpegPath "ffmpeg" -StartKeepTime "mm:ss" -EndKeepTime "h:mm:ss"
