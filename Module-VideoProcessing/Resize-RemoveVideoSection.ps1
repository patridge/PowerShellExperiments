...
# Sample: Should find the prior video generated by `Resize-TrimVideoEnds`.
# Resize-RemoveVideoSection -VideoPath "*-combined-trimmed.mp4" -FFmpegPath "ffmpeg" -StartRemoveTime "h:mm:ss" -EndRemoveTime "h:mm:ss"
